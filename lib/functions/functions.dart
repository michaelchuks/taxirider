...
//base url
String url =
    'https://dton.ng/'; //add '/' at the end of the url as 'https://url.com/'
String mapkey = 'AIzaSyDEQPFXHwK_6j779dkuMkF_kSpmjn7uJvg';
String mapStyle = '';
String mapType = '';
...
geoCodingForLatLng(place) async {
  dynamic location;
  try {
    List<Location> value =
...
getAutocomplete(input, sessionToken, lat, lng) async {
  try {
    ...
    for (var element in result.predictions) {
      addAutoFill
          .add({'place': element.placeId, 'description': element.primaryText});
    }
