                                                                                                ...
                                                                                                Container(
                                                                                                    ...
                                                                                                    child: (driverReq.isNotEmpty)
                                                                                                        ? Text(
                                                                                                            ...
                                                                                                            softWrap: false,
                                                                                                            style: GoogleFonts.notoSans(color: textColor, fontSize: (platform == TargetPlatform.android) ? media.width * ten : media.width * fourteen),
                                                                                                          )
                                                                  ...
                                                                  onTap:
                                                                    ...
                                                                    if (((userDetails['vehicle_type_id'] !=
                                                                      ...
                                                                      if (userDetails[
                                                                              'active'] ==
                                                                          false) {
                                                                        if (pref.getBool('isOverlaypermission') !=
                                                                            false) {
                                                                        ...
                                                                        GestureDetector(
                                                                          ...
                                                                          onVerticalDragEnd:
                                                                            ...
                                                                            if (gesture.isNotEmpty &&
                                                                                start > gesture[gesture.length - 1] &&
                                                                                _bottom == 0) {
                                                                              setState(() {
                                                                                _bottom = 1;
                                                                              });
                                                                            } else if (gesture.isNotEmpty && start < gesture[gesture.length - 1] && _bottom == 1) {
                                                                              setState(() {
                                                                                _bottom = 0;
                                                                              });
                                                                            }
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            width:
                                                                                media.width * 1,
                                                                            decoration:
                                                                                BoxDecoration(borderRadius: const BorderRadius.only(topLeft: Radius.circular(10), topRight: Radius.circular(10)), color: page),
                                                                            child:
                                                                                Column(
                                                                              children: [
                                                                                Container(
                                                                                ...
                                                                                Row(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    (driverReq['is_driver_arrived'] == 1 && waitingTime != null && driverReq['is_trip_start'] == 0)
                                                                                        ? (waitingTime / 60 >= 1)
                                                                                            ? Container(
                                                                                                padding: EdgeInsets.all(media.width * 0.03),
                                                                                                      ...
                                                                                                      children: [
                                                                                                        ...
                                                                                                        Row(
                                                                                                          ...
                                                                                                          children: [
                                                                                                            ...
                                                                                                            MyText(text: driverReq['payment_type_string'].toString(), size: media.width * fourteen, color: textColor),
                                                                                                          ],
                                                                                                        ),
                                                                                                      ],
                                                                                                    ),
                                                                                                        ...
                                                                                                        children: [
                                                                                                          ...
                                                                                                          SizedBox(
                                                                                                            ...
                                                                                                            child: Text(
                                                                                                              ...
                                                                                                              style: GoogleFonts.notoSans(fontSize: media.width * twelve, color: const Color(0xFFFF0000), fontWeight: FontWeight.w600),
                                                                                                            ),
                                                                                                          ),
                                                                                                        ],
                                                                                                      ))
